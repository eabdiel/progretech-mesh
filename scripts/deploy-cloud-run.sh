...
ARGS=(
  ...
  --set-env-vars "APP_ENV=production,MESH_DEPLOYMENT_TIER=${DEPLOYMENT_TIER},MESH_VERSION=1.6.0-v1-phase6,BUILD_ID=v1-phase-6-of-7-20260912,FLASK_DEBUG=0,TRUST_PROXY_HEADERS=1,DEV_AUTH_ENABLED=0,DEV_SEED_AGENTS=0,MESH_AUTH_MODE=oidc,MESH_AGENT_IDENTITY_MODE=codeseal,CODESEAL_VERIFIER_MODE=${CODESEAL_VERIFIER_MODE:-unconfigured},MESH_OIDC_READY=${MESH_OIDC_READY:-0},MESH_CODESEAL_READY=${MESH_CODESEAL_READY:-0}"
